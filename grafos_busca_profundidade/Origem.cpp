...
{
    int TotalVertices;
    struct ListaDeVizinhos** ListaAdj; // Poderia ser um vetor do tamanho do numero de vertices
};

struct STACK // Pilha dos vertices a serem visitados
{
    int vertice;
    STACK* prox;
} *top = NULL;
...
int main()
{
    int marcado[NUMERO_VERTICES] = { 0 };//0 nao visitado; 1 - visitado
    int origem;
...
void push(int y)
{ // funcao push, coloca um elemento na pilha
...
void pop()
{ // funcao pop, remove um elemento na pilha
